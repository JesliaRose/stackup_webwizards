...
const Checkout = () => {
  ...
  return (
    <div className="h-screen bg-wishquire-background">
      <div className="min-w-[500px] max-w-[1500px] m-auto pt-8">
        <div className="grid grid-cols-8 gap-10">
          ...
          <div className="col-span-6 bg-white rounded-2xl">
            ...
            {products.map((product) => {
              return (
                <div key={product.id}>
                  <div className="grid grid-cols-12 divide-y divide-wishquire-lightblue mr-4">
                    <div className="col-span-10 grid grid-cols-8 divide-y divide-wishquire-lightblue">
                      ...
                      <div className="col-span-6">
                        ...
                        <div className="grid grid-cols-3 w-20 text-center">
                          <div
                            className="text-xl xl:text-2xl bg-gray-400 rounded-s cursor-pointer"
                            onClick={() =>
                          ...
                          <div
                            className="text-xl xl:text-2xl bg-gray-400 rounded-e cursor-pointer"
                            onClick={() =>
          ...
          {/* Checkout */}
          <div className="col-span-2 bg-white rounded-2xl h-[250px] p-7">
