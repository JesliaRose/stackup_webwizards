...
const Search = () => {
  ...
  return (
    <div className="w-[100%]">
      <div className="flex items-center h-10 bg-wishquire-yellow rounded">
        <select
          onChange={(e) => setCategory(e.target.value)}
          className=" bg-wishquire-yellow  text-wishquire-darkblue text-xs xl:text-lg pl-2"
        >
          <option>All</option>
          <option>Deals</option>
          <option>Wishquire</option>
